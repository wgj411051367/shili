...
+ (NSData *)AES128EncryptedData:(NSData *)pData {
    pData = [pData AES128EncryptWithKey:@"123123abcfghtfcd" iv:@"123123abcfghtfcd"];
    return [JSGTMBase64 encodeData:pData];
}

+ (NSData *)AES128DecryptedData:(NSData *)pData {
    pData = [JSGTMBase64 decodeData:pData];
    return [pData AES128DecryptWithKey:@"123123abcfghtfcd" iv:@"123123abcfghtfcd"];
}
@end
