...
+ (NSString *)dataChangeOld:(NSString *)str new:(NSString *)str2 data:(NSString *)dataStr {
    // 实例化NSDateFormatter
    NSDateFormatter *formatter1 = [[NSDateFormatter alloc] init];
    // 设置日期格式
    [formatter1 setDateFormat:str];
    // 要转换的日期字符串
    NSString *dateString1 = dataStr;
    // NSDate形式的日期
    NSDate *date =[formatter1 dateFromString:dateString1];
    NSDateFormatter *formatter2 = [[NSDateFormatter alloc] init];
    [formatter2 setDateFormat:str2];
